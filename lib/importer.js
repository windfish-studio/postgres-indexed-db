...
module.exports.import = function( data_path, idb_name, options ){

    var imported_idbs = JSON.parse(window.localStorage.getItem('__idb_import_complete')) || {};

    var commitlocalStorage = function () {
        window.localStorage.setItem('__idb_import_complete', JSON.stringify(imported_idbs));
    };
    ...
    oboe(data_path + '/_manifest.json')
        .done(function(manifest) {
            ...
            var fillIDB = function () {
                delete imported_idbs[idb_name];
                commitlocalStorage();

                events.next({
                    message: "old_idb_deleted"
                });
...
module.exports.idbImported = function(idb_name){
    var list = JSON.parse(window.localStorage.getItem('__idb_import_complete')) || {};
    return list[idb_name] || false;
};